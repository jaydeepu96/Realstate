...
import '../ComponentCss/LatestNews.css'
const Ourlatestnews = () => {
  return (
    <>
   <Container style={{backgroundColor:"#00326f"}}>
        <Row>
          <Col md={4} style={{marginLeft:"150px"}}><Card style={{ width: '18rem',padding:"10px"}} >
      <Card.Body>
        ...
        <Col md={4}><Card style={{ width: '18rem',padding:"20px",marginLeft:"150px" }}>
      ...
      <Card.Body>
        ...
        <Button className='newbtn'>READ ARTICLE</Button>
      </Card.Body>
    </Card></Col>
